...
## 기능 요약(탭)
- **지방선거**: 단체장(광역/기초·낙선 전원)·교육감(성향)·지방의원(광역/기초 지역구·선거구별 낙선 전원, **광역비례·기초비례** 정당별 의석·당선자). 시도 클릭=광역의회(광역의원+비례), 시군구 클릭=기초의회(기초의원+비례) 의석분포 도넛. **제1당 동률 시 경합(무소속색)** 표시
- **국회의원**: 시도 choropleth(13~22대) → **시도 클릭 시 그 시도의 지역구별 결과(당선+낙선 전원)** 드릴다운(14~22대, 선관위 OpenAPI). + 전체 선거구 경계지도(21·22대, 투표구별). 선거구 자연순 정렬(제1<제2<…제10, 갑을병정, 가나다…하·거…)
- **대통령**: 16~21대 시도→시군구 드릴다운, 후보 전원·투표구별·**역대 진영별 득표율 추이 차트**
- **투표소 조회**: 대선/총선 토글 → 시도→시군구(대선)/선거구(총선) 선택 후 **투표구/읍면동별** 후보 전원 득표 표. 대선은 **행 클릭 시 그 읍면동의 역대 대선 진영별 득표율 추이** 차트 (지선은 선관위 투표구 미제공으로 제외)
- **개관**: 선거종류(총선/단체장/지방의원·비례/대선)별 **데이터 사실 분석** — 최신 회차 제1당·격차, **직전 회차 대비 의석 증감(▲▼)**, 정당별 의석·득표율 **추이 차트** (객관 지표만; 전망·평가 제외)
