...
def main():
    ...
    # 신설 자치구(편입/분구). 지도는 별도 합성 폴리곤(프론트 incheon-2026) 사용.
    #   인천 2026-07-01 개편: 중구·동구→영종구+제물포구, 서구 분구→검단구(서구 잔존).
    #   9회(2026) 지선이 신설구 단체장·의원을 선출 → 9회부터 신설구 코드로 적재.
    new_districts = [
        ("23090", "검단구", "28"), ("23100", "영종구", "28"), ("23110", "제물포구", "28"),
    ]
